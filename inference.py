...
model_malignancy.load_weights(
    ROOT / "models/vgg16_malignancy_best_val_accuracy.h5",
    by_name=True,
    skip_mismatch=True,
)
...
model_nodule_type.load_weights(
    ROOT / "models/vgg16_noduletype_best_val_accuracy.h5",
    by_name=True,
    skip_mismatch=True,
)
...
image = sitk.ReadImage(
    str(
        ROOT
        / "test/images/ct/01_1.3.6.1.4.1.14519.5.2.1.6279.6001.100225287222365663678666836860_45_211_77_0000.nii.gz"
    )
)
